            ...
            <article class="registerInput">
                ...
                <div class="form-group p-4">
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-lg" type="text" placeholder="Identifiant" aria-label=".form-control-lg example" name="registerUserName" id="registerUserNameID" value="<?php if (
                            isset($username)
                        ) {
                            echo $username;
                        } ?>" /></p>
