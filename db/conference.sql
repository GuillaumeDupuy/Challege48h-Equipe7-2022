...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1917242248ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=conference&table=evenement">`conference`.`evenement`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=conference&table=utilisateurs">`conference`.`utilisateurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=categorie">`db_commerce`.`categorie`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=produit">`db_commerce`.`produit`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=commentaire">`db_commerce`.`commentaire`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=user">`db_commerce`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=contact">`db_commerce`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=messenger_messages">`db_commerce`.`messenger_messages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_panier&table=product">`db_panier`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_commerce&table=doctrine_migration_versions">`db_commerce`.`doctrine_migration_versions`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="30297529323257715f4e4264723d7440">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="db_commerce" targettable="categorie">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `categorie`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="categorie">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `categorie`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="produit">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `produit`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="produit">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `produit`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="commentaire">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `commentaire`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="commentaire">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `commentaire` ORDER BY `produit_id` ASC </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="commentaire">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `produit`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_commerce" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            targetdb="conference" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE utilisateurs
(
    ...
    admin boolean
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE Evenement
(
    id INT PRIMARY KEY NOT NULL,
    image varchar(255),
    ...
    description varchar(255)
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="conference" targettable="evenement">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `evenement`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="conference" targettable="utilisateurs">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `utilisateurs`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="conference" targettable="evenement">
                            <div class="action_content">
